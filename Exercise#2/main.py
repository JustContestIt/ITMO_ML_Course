...
if len(x1) == 2:
    print("Третий ответ: " + str(x1[1]))
else:
    print("Третий ответ: " + str(x1[0]))
...
print("Введите в ответ номер рисунка, который получился после выполнения кода")
plt.show()